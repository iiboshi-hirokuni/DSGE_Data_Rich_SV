...
mhrun  = "5_SV";        @ 3_SV:data_rich_A,  4: data_rich_B,  5_SV: data_rich_C   @
...
if mhrun == "3_SV";
   output file= c:\DSGE_NIMN_V0\results\sv_shock_sample_A.txt reset; 
elseif mhrun == "4_SV";
    output file= c:\DSGE_NIMN_V0\results\sv_shock_sample_B.txt reset; 
elseif mhrun == "5_SV";
     output file= c:\DSGE_NIMN_V0\results\sv_shock_sample_C.txt reset; 
endif;
