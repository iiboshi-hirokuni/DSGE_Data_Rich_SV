...
mhrun  = "5_SV";   @ 3_SV:case A,   5_SV: case C,  0: prior,    2:regular DGE    @

nburn       = 3000;            /* Number of initial draws to be discarded */
hpdprob     = 0.90;         /*  Credible Band  */  
nblock      = 50;        /*  number of draws for one block */
...
draw_names_A = { s1_sig s1_rho s1_phi s1_mu  s2_sig s2_rho s2_phi s2_mu 
		         s3_sig s3_rho s3_phi s3_mu  s4_sig s4_rho s4_phi s4_mu 
		         s5_sig s5_rho s5_phi s5_mu  s6_sig s6_rho s6_phi s6_mu 
		         s7_sig s7_rho s7_phi s7_mu  s8_sig s8_rho s8_phi s8_mu 
	             StD_1 StD_2 StD_3 StD_4 StD_5 StD_6 StD_7 StD_8 StD_9 StD_10 StD_11
                 rho_1 rho_2 rho_3 rho_4 rho_5 rho_6 rho_7 rho_8 rho_9 rho_10 rho_11  };


draw_names_C = { s1_sig s1_rho s1_phi s1_mu  s2_sig s2_rho s2_phi s2_mu 
		         s3_sig s3_rho s3_phi s3_mu  s4_sig s4_rho s4_phi s4_mu 
		         s5_sig s5_rho s5_phi s5_mu  s6_sig s6_rho s6_phi s6_mu 
		         s7_sig s7_rho s7_phi s7_mu  s8_sig s8_rho s8_phi s8_mu 
                 ...
                 StD_21 StD_22 StD_23 StD_24 StD_25 StD_26 StD_27 StD_28 StD_30
                 StD_31 StD_32 StD_34 StD_36 StD_37 StD_38 StD_39 StD_40
                 ...
                 rho_21 rho_22 rho_23 rho_24 rho_25 rho_26 rho_27 rho_28 rho_30
                 rho_31 rho_32 rho_34 rho_36 rho_37 rho_38 rho_39 rho_40
                 Gam_1  Gam_2 Gam_3 Gam_4 Gam_5 Gam_6 Gam_7 Gam_8 Gam_9 
                 Gam_11  Gam_12 Gam_13 Gam_14 Gam_15 Gam_16 Gam_17 Gam_18 Gam_19 Gam_20
                 Gam_21  Gam_22 Gam_23 Gam_24 Gam_25 Gam_26 Gam_27 Gam_28 Gam_30
                 Gam_31  Gam_32 Gam_34 Gam_36 Gam_37 Gam_38 Gam_39 Gam_40  };



if    mhrun  == "3_SV";
    outmat = outmat|
             draw_names_A'~real(drawmean[.,28:49+32]')~ real(drawcd[3,28:49+32]')~ real(drawstdd[.,28:49+32]')
             ~ real(drawci[.,28:49+32]')~ real(drawcd[1:2,28:49+32])' ;
/*
elseif  mhrun  == "5";
    outmat = outmat|
...
elseif  mhrun  == "5_SV";
    outmat = outmat|
             draw_names_C'~real(drawmean[.,28:135+32]')~ real(drawcd[3,28:135+32]')~ 
             real(drawstdd[.,28:135+32]')
             ~ real(drawci[.,28:135+32]')~ real(drawcd[1:2,28:135+32])' ;

/*
elseif  mhrun  == "5";
    outmat = outmat|
             draw_names_C'~real(drawmean[.,28:126]')~ real(drawcd[3,28:126]')~ real(drawstdd[.,28:126]')
             ~ real(drawci[.,28:126]')~ real(drawcd[1:2,28:126])' ;
*/
/*
elseif mhrun == "4" ;
     outmat = outmat|
...
if mhrun == "3_SV";
     output file= c:\DSGE_NIMN_V0\results\para_a_SV.txt reset; 
elseif mhrun == "4_SV";
     output file= c:\DSGE_NIMN_V0\results\para_b_SV.txt reset;
elseif mhrun == "5_SV";
     output file= c:\DSGE_NIMN_V0\results\para_c_SV.txt reset;
endif; 
