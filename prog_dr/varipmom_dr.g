...
if mhrun == "3";
       ...
       output file= c:\dge_BGG_GK\results\state_sample_A.txt reset; 

elseif mhrun == "4";
       output file= c:\dge_BGG_GK\results\state_sample_B.txt reset; 

elseif mhrun == "5";
      output file= c:\dge_BGG_GK\results\state_sample_C.txt reset; 
endif;
