...
nburn       = 5000;        /* Number of initial draws to be discarded */
...
if mhrun == "3";
   output file= c:\dge_bgg_gK\results\shock_sample_A.txt reset; 
elseif mhrun == "4";
    output file= c:\dge_bgg_gK\results\shock_sample_B.txt reset; 
elseif mhrun == "5";
     output file= c:\dge_bgg_gK\results\shock_sample_C.txt reset; 
endif;
