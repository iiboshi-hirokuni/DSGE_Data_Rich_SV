...
#include c:\dge_BGG_GK\loaddata.g;   //case_c_zz; wait;   
...
do until iblock > nblocks;
   ...
   "Parameters       "; meanc(parasim)'; 
	...
	if (iblock > 1+burnin_blocks) and (fmod(iblock,nblocks/10)== 0); 
	   #include c:\dge_bgg_gk\prog_dr\hist_decomp_save.src; 
    endif;
...
#include c:\dge_BGG_GK\prog_dr\bgg_gk_lh_dr_C.src;  
#include c:\dge_BGG_GK\prog_dr\bgg_gk_data_rich_C.src; 
