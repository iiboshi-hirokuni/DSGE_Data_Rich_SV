...
nblock      = 10;       /*  number of draws for one block */
...
if mhrun == "3";
   output file= c:\dge_bgg_gK\prog_case_c\results\shock_sample_A.txt reset; 
elseif mhrun == "4";
    output file= c:\dge_bgg_gK\prog_case_c\results\shock_sample_B.txt reset; 
elseif mhrun == "5";
     output file= c:\dge_bgg_gK\prog_case_c\results\shock_sample_C.txt reset; 
endif;
